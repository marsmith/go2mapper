...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Highcharts, $, __webpack_provided_L_dot_esri, convex, moment) {// ------------------------------------------------------------------------------
	// ----- NY Go2 Mapper ----------------------------------------------------------
	// ------------------------------------------------------------------------------
	...
	$(document).ready(function () {
		console.log('Application Information: ' + ("development") + ' ' + 'version ' + ("1.1.0"));
		$('#appVersion').html('Application Information: ' + ("development") + ' ' + 'version ' + ("1.1.0"));
	...
	function openPopup(e) {
		...
		if (e.layer.properties.siteType === 'sw' || e.layer.properties.siteType === 'gw') {
			...
			$.getJSON(USGSwaterServicesURL + e.layer.properties.siteID + '&parameterCd=' + parameterCodes + '&period=' + timePeriod, function (data) {
				...
				var query = __webpack_provided_L_dot_esri.query({ url: NWMmapServiceURL });
	...
	function selectCenter(selectedCenter) {
		...
		getConvexHull('center', selectedCenter);
	...
	function selectTrip(tripData) {
		...
		//get convex hull and zoom to
		if (selectLayer.getLayers().length <= 2) map.flyToBounds(selectLayer.getBounds());else getConvexHull('trip', tripData.tripName);
	}

	function getConvexHull(type, text) {
		//create convex hull
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(2), __webpack_require__(3), __webpack_require__(5), __webpack_require__(24)))
